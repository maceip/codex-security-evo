...
export const INSIGHTS_DIR = join(homedir(), ".codex-security", "insights");
/** Index file: maps "language:vulnerability_class" to capsule file names. */
const INDEX_PATH = join(INSIGHTS_DIR, "index.json");
/**
 * Write a capsule to disk and update the index.
 */
export async function depositInsight(capsule) {
 ...
 */
export async function retrieveInsights(language, vulnerabilityClass) {
    const index = await loadIndex();
 ...
 */
export async function deleteInsight(capsuleId) {
